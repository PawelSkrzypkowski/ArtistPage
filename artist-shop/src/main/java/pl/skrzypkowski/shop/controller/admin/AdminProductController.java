package pl.skrzypkowski.shop.controller.admin;
...
import pl.skrzypkowski.shop.service.CategoryService;
import pl.skrzypkowski.shop.service.ProductService;
...
public class AdminProductController {
	...
	public String save(@Valid Product product, BindingResult result, Model model, RedirectAttributes redirect) {
		...
		redirect.addFlashAttribute("success", "Zapisano produkt pomyślnie!");
	...
	public String delete(@PathVariable Integer id, RedirectAttributes redirect) {
		...
		redirect.addFlashAttribute("success", "Usunięto produkt pomyślnie!");
		return "redirect:/admin/product";
	}
	...
	public String postUpload(@PathVariable("id") Integer id, @RequestParam("image") MultipartFile imageFile, 
		...
		redirect.addFlashAttribute("success", "Przesłano zdjęcia pomyślnie!");
		return "redirect:/admin/product";
	}
